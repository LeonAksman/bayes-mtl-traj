...
loopVars.tasks                        	= 50;       	%number of tasks (number of subjects in multi-task trajectory modeling)   
...
loopVars.numRngs                      	= 20;     	%number of simulation runs, each a random sampling of trajectories
loopVars.numTestSamples                 = 1;

saveFile_int                            = '../out_blr_sim/int_quick_new.mat';
saveFile_slope                       	= '../out_blr_sim/slope_quick_new.mat';
