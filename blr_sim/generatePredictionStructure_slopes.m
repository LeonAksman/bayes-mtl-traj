function [predictStruct, traj_coeffs, true_diffs] = generatePredictionStructure_slopes(params)
...
true_diffs                     = randsample(-1:-.5:-3,   n_tasks, true);

traj_coeffs                     = zeros(n_tasks, 2);
traj_coeffs(:, 1)               = 0;
traj_coeffs(:, 2)               = true_diffs; % + normrnd(0, paramNoise, 1, n_tasks);
