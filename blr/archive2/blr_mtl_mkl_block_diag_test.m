function [varargout] = blr_mtl_mkl_block_diag_test(hyp, X, t, nTasks, numBlocks, extraKernels, xs)
...
for i = 1:numBlocks
    ...
    exp_hyps_i    	= zeros(length(index_i), 1);    %exp(hyp(index_i));
  
    alpha1          = 0;                            %exp_hyps_i(1);
    alpha2          = 0;                            %exp_hyps_i(2);
